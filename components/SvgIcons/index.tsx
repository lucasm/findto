...
export const IconPatreon = () => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32">
    <path
      fill="currentColor"
      d="m30.66,9.61c0-4.09-3.2-7.43-6.94-8.64-4.65-1.5-10.79-1.28-15.23.81C3.1,4.31,1.41,9.86,1.35,15.39c-.05,4.55.4,16.53,7.18,16.61,5.04.06,5.79-6.41,8.12-9.52,1.66-2.22,3.79-2.84,6.42-3.49,4.52-1.11,7.59-4.67,7.59-9.37Z"
    />
  </svg>
)
export const IconKofi = () => (
  <svg
    ...
    <path
      ...
      fillRule="nonzero"
      stroke="none"
      strokeWidth="0.407028"
      strokeLinecap="butt"
      strokeLinejoin="miter"
      strokeMiterlimit="10"
      strokeDasharray="none"
      d="M15.135 3.617c-3.6 0-6.648.036-9.108.348C2.772 4.38 0 6.875 0 11.48c0 4.676.243 8.173 2.113 11.325 2.113 3.601 5.645 5.576 10.217 5.576h1.107c5.61 0 8.658-2.98 10.182-5.334.658-1.04 1.144-2.078 1.455-3.117C29.057 19.584 32 16.295 32 12.277v-.554c0-4.33-2.839-7.344-7.723-7.828-2.078-.208-3.532-.276-9.142-.276Zm0 2.6c5.61 0 6.788.07 8.761.242 3.499.415 5.506 2.112 5.506 5.332v.52c0 2.875-2.39 5.126-5.16 5.126h-1.246l-.209.866c-.277 1.351-.796 2.424-1.385 3.394-1.212 1.905-3.394 4.086-7.896 4.086h-1.072c-3.43 0-6.444-1.177-8.106-4.26-1.454-2.666-1.73-5.54-1.73-10.007v-.002c0-2.909 1.143-4.536 4.017-4.952 2.043-.311 4.745-.345 8.52-.345Zm8.728 3.047c-.554 0-.867.312-.867.728v3.912c0 .416.313.727.867.727 1.766 0 2.735-1.004 2.735-2.666s-.969-2.701-2.735-2.701zm-13.853.242c-2.425 0-4.018 1.973-4.018 4.19 0 2.043 1.143 3.809 2.598 5.195.97.935 2.493 1.906 3.531 2.529.312.173.624.277.97.277.417 0 .762-.104 1.04-.277 1.04-.624 2.563-1.594 3.498-2.53 1.49-1.384 2.63-3.15 2.63-5.195 0-2.216-1.66-4.19-4.05-4.19-1.42 0-2.39.728-3.117 1.731-.658-1.004-1.662-1.73-3.082-1.73z"
    />
  </svg>
)
