      ...
      <section>
        <div className={Style.container}>
          <article>
            <h2>1. Terms</h2>
            <p>
              By accessing the website at <a href="http://findto.app">http://findto.app</a>, you are
              agreeing to be bound by these terms of service, all applicable laws and regulations,
              and agree that you are responsible for compliance with any applicable local laws. If
              you do not agree with any of these terms, you are prohibited from using or accessing
            ...
            <ol type="a">
              <li>
                ...
                or software) on Findto's website for personal, non-commercial transitory viewing
                ...
                <ol type="i">
                  ...
                  <li>
                    attempt to decompile or reverse engineer any software contained on Findto's
                    website;
                  </li>
                  <li>
            ...
            <ol type="a">
              <li>
                The materials on Findto's website are provided on an 'as is' basis. Findto makes no
              ...
              <li>
                Further, Findto does not warrant or make any representations concerning the
            ...
            <p>
              Findto may revise these terms of service for its website at any time without notice.
